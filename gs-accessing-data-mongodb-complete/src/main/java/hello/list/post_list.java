...
//		//测试
//		post_list.post("CP23010020140102107100");
//	}
		...
		// TODO Auto-generated method stub
				 try {
					...
					httpclient.getParams().setParameter(CoreConnectionPNames.SO_TIMEOUT,60000);
					 ...
					 String url="<message module='CATALOG_SERVICE' version='2.0'><header action='REQUEST' command='RELATIVE_CONTENT_QUERY' sequence='10000000001' component-id='CATALOG_SERVER1' component-type='CATALOG_SERVER'/><body><folders><folder><code>"+code+"</code><page-index>1</page-index><page-items>50000</page-items><site-code>xinjiang_vsite</site-code></folder></folders></body></message>";
